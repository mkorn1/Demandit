  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input
        ...
        placeholder="Type your message... (Chat functionality coming soon)"
        className="flex-1 px-4 py-3 bg-black text-white border border-blue-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-900 focus:border-red-900 placeholder-white placeholder-opacity-50"
      />
      <button
        type="submit"
